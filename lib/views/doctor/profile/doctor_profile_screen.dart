      ...
      body: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          CircleAvatar(
            ...
            child: imageBytes == null ? const Icon(Icons.person_rounded, size: 70, color: AppColors.textGray) : null,
          ),
          const SizedBox(height: 16),
          Text(user.name ?? 'Doctor', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: AppColors.textDark, fontFamily: 'Poppins')),
          const SizedBox(height: 4),
          const Text('Doctor', style: TextStyle(fontSize: 14, color: AppColors.textGray, fontFamily: 'Poppins')),
